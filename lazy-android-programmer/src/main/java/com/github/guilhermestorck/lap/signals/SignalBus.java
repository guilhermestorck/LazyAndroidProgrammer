...
public class SignalBus {
    ...
    public static void sendSignal(String signalName, Object... signalParams) {
    ...
    public static View.OnClickListener signalOnClick(final String signalName, final Object... signalParams) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendSignal(signalName, signalParams);
            }
        };
    }

    public static View.OnLongClickListener signalOnLongClick(final String signalName, final Object... signalParams) {
    ...
    private static SignalCallback signal(String signalName, Object... signalParams) {
