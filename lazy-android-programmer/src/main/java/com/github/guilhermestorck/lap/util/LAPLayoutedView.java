...
public class LAPLayoutedView {
    ...
    public static LAPLayoutedView wrap(View view) {
        return new LAPLayoutedView(view).wrapHeight().wrapWidth();
    }

    public static LAPLayoutedView fill(View view) {
        return new LAPLayoutedView(view).fillHeight().fillWidth();
    }

    public static LAPLayoutedView wrapHeightFillWidth(View view) {
        return new LAPLayoutedView(view).wrapHeight().fillWidth();
    }

    public static LAPLayoutedView fillHeightWrapWidth(View view) {
        return new LAPLayoutedView(view).fillHeight().wrapWidth();
    }
